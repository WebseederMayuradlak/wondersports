    ...
    <div className='main-blog-page'>
      ...
      <div className="blog-about-us">
        <div className="about-text">
          <div className="mytext">
            <h5>About Us </h5>
            <h3>we guide traveller explore <br /> the world </h3>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure error minima, ea exercitationem molestias, cumque odio et omnis quia quas quisquam dolores sequi repellendus laboriosam suscipit doloremque eum, ipsum quos.</p>
            <div className='brdr'>
              <h3>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus pariatur quos facilis, commodi officiis dolor.</h3>
              <p>Juhn Doe</p>
              <span>Founder </span>
            </div>
          </div>
      ...
      <div className="places">
        <div className="place-text">
          ...
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corporis qui  mollitia ea cum <br /> magni nemo, vero a explicabo ipsa est?
          </p>
        </div>
