...
const SnowtourGuide = () => {
  return (
    <>
      <div className="snow-tour-guide">
        <div className="snow-guide-page">
          <div className="snow-guide-text">
            <span>snow Tour Guide - Tour Guide </span>
            <h3>
        ...
        <div className="snow-guide-1">
          <div className="snow-guide-text-1">
          ...
          <div className="snow-guide-text-3">
          ...
          <div className="snow-guide-img-3">
            <img src={Image02} alt="My Image" height="400px" width="500px" />
          </div>
          <div className="snow-guide-img-4">
            <img src={Image01} height="400px" width="500px" alt="My Image" />
          </div>
          <div className="snow-guide-text-4">
          ...
          <div className="snow-guide-img-5">
            <div className="snow-mytext">
        ...
        <div className="snow-content">
          <div className="snow-content-1">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
          <div className="snow-content-2">
            <div className="snow-content2-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>
            <div className="snow-content2-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
            &nbsp;
          </div>
          <div className="snow-content-3">
            <div className="snow-content3-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>{" "}
            &nbsp;
            <div className="snow-content3-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
          </div>
          <div className="snow-content-4">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
        </div>
      </div>
