...
const BeachandDiving = () => {
  return (
    <>
      <div className="beach-and-diving">
        <div className="beach-guide-page">
          <div className="beach-guide-text">
            <span>beach Tour Guide - Tour Guide </span>
            <h3>
        ...
        <div className="beach-guide-1">
          <div className="beach-guide-text-1">
          ...
          <div className="beach-guide-text-3">
          ...
          <div className="beach-guide-img-3">
            <img src={Image02} alt="My Image" height="400px" width="500px" />
          </div>
          <div className="beach-guide-img-4">
            <img src={Image01} height="400px" width="500px" alt="My Image" />
          </div>
          <div className="beach-guide-text-4">
          ...
          <div className="beach-guide-img-5">
            <div className="beach-mytext">
        ...
        <div className="beach-content">
          <div className="beach-content-1">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
          <div className="beach-content-2">
            <div className="beach-content2-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>
            <div className="beach-content2-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
            &nbsp;
          </div>
          <div className="beach-content-3">
            <div className="beach-content3-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>{" "}
            &nbsp;
            <div className="beach-content3-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
          </div>
          <div className="beach-content-4">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
        </div>
      </div>
