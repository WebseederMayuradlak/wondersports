...
function HistoryandHeritage() {
  return (
    <div>
      <div className="history-guide-page">
        <div className="history-guide-text">
          <span>history Tour Guide - Tour Guide </span>
          <h3>
      ...
      <div className="history-guide-1">
        <div className="history-guide-text-1">
          ...
          <p>
            ...
            distinctio pariatur nostrum magnam dolorem dolores necessitatibus a
            enim? Nemo obcaecati minus laudantium debitis amet placeat molestias
            fugit incidunt officia unde dignissimos itaque ex quod, ea quidem.
            Eum!
          </p>
        </div>
        <div className="history-guide-img-1">
          <img src={Image01} alt="My Image" height="400px" width="500px" />
        </div>
        <div className="history-guide-img-2">
          <img src={Image02} alt="My Image" height="400px" width="500px" />
        </div>
        <div className="history-guide-text-2">
          ...
          <p>
            ...
            adipisicing elit. Eligendi, sit? amet consectetur adipisicing elit.
            Dolorem asperiores ipsa vitae, quidem ipsum corrupti maxime
        ...
        <div className="history-guide-text-3">
        ...
        <div className="history-guide-img-3">
          <img src={Image02} alt="My Image" height="400px" width="500px" />
        </div>
        <div className="history-guide-img-4">
          <img src={Image01} height="400px" width="500px" alt="My Image" />
        </div>
        <div className="history-guide-text-4">
          ...
          <p>
            ...
            est aut aperiam ea architecto ullam iure? Odio maxime accusamus fuga
            accusantium dignissimos dolor ducimus. Sapiente, nostrum enim, error
            vitae dolorem obcaecati reprehenderit quisquam, perspiciatis quae
            tempora distinctio architecto saepe! Aspernatur, harum ut
          </p>
        </div>
        <div className="history-guide-img-5">
          <div className="history-mytext">
            <h3> For Travel Experience Book Online Today</h3>
            <p>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Lorem,
              ipsum dolor sit amet consectetur adipisicing elit. Maxime vel
              ratione est adipisci pariatur culpa, earum veniam suscipit itaque
              expedita. Porro, nobis excepturi. Maiores beatae amet, eos earum
              vel saepe quas facere impedit magnam libero expedita fuga officia
              molestias. Reiciendis, commodi officia!
            </p>
            <a href="/">See Tour </a>
          </div>
        </div>
        <div className="history-guide-text">
          ...
          <p>
            ...
            Eaque impedit esse fuga repudiandae expedita. Error accusantium quo
            optio temporibus expedita.
          </p>
          <a href="/">Explore </a>
        </div>
      </div>
      ...
      <div className="history-content">
        ...
        <div className="history-content-2">
          <div className="history-content2-img-1">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
          <div className="history-content2-img-2">
            <img src={Image03} alt="My Image" height="270px" width="380px" />
          </div>
          &nbsp;
        </div>
        <div className="history-content-3">
          <div className="history-content3-img-1">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>{" "}
          &nbsp;
          <div className="history-content3-img-2">
            <img src={Image03} alt="My Image" height="270px" width="380px" />
          </div>
        </div>
