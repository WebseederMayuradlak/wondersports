    ...
    <div>
      ...
      <div className="photo-guide-page">
          <div className="photo-guide-text">
            <span>photo Tour Guide   - Tour Guide  </span>
        ...
        <div className="photo-guide-1">
          <div className="photo-guide-text-1">
          ...
          <div className="photo-guide-img-1">
            <img src={Image01} alt="" height='400px' width='500px' />
          </div>
          <div className="photo-guide-img-2">
            <img src={Image02} alt="" height='400px' width='500px' />
          </div>
          <div className="photo-guide-text-2">
          ...
          <div className="photo-guide-text-3">
          ...
          <div className="photo-guide-img-3">
            <img src={Image02} alt="" height='400px' width='500px' />
          </div>
          <div className="photo-guide-img-4">
            <img src={Image01} height='400px' width='500px' alt="" />
          </div>
          <div className="photo-guide-text-4">
          ...
          <div className="photo-guide-img-5">
            <div className="photo-mytext">
        ...
        <div className="photo-content">
          ...
          <div className="photo-content-2">
            <div className="photo-content2-img-1">
              <img src={Image03} alt="" height='450px' width='380px' />

            </div>
            <div className="photo-content2-img-2">
              <img src={Image03} alt="" height='270px' width='380px' />

            </div>
            &nbsp;
          </div>
          <div className="photo-content-3">
            <div className="photo-content3-img-1">
              <img src={Image03} alt="" height='450px' width='380px' />
            </div>  &nbsp;
            <div className="photo-content3-img-2">
              <img src={Image03} alt="" height='270px' width='380px' />
            </div>
          </div>
