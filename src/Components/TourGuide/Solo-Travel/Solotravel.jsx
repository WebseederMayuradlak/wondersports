...
function Solotravel() {
  return (
    <>
      <div className="solo-travel-guide">
        <div className="solo-guide-page">
          <div className="solo-guide-text">
            <span>Solo travel Tour Guide - Tour Guide </span>
            <h3>
        ...
        <div className="solo-guide-1">
          <div className="solo-guide-text-1">
          ...
          <div className="solo-guide-text-3">
          ...
          <div className="solo-guide-img-3">
            <img src={Image02} alt="My Image" height="400px" width="500px" />
          </div>
          <div className="solo-guide-img-4">
            <img src={Image01} height="400px" width="500px" alt="My Image" />
          </div>
          <div className="solo-guide-text-4">
          ...
          <div className="solo-guide-img-5">
            <div className="solo-mytext">
        ...
        {/* <div className="solo-content">
          ...
          <div className="solo-content-2">
            <div className="solo-content2-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>
            <div className="solo-content2-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
            &nbsp;
          </div>
          <div className="solo-content-3">
            <div className="solo-content3-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>{" "}
            &nbsp;
            <div className="solo-content3-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
          </div>
