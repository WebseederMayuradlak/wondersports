...
const NorthTourGuide = () => {
  return (
    <>
      <div className="north-tour-guide">

        <div className="north-page">
          <div className="north-text">
            <span>North America   - Tour Guide  </span>
        ...
        <div className="north-guide-1">
          <div className="north-guide-text-1">
          ...
          <div className="north-guide-img-1">
            <img src={Image01} alt="" height='400px' width='500px' />
          </div>
          <div className="north-guide-img-2">
            <img src={Image02} alt="" height='400px' width='500px' />
          </div>
          <div className="north-guide-text-2">
          ...
          <div className="north-guide-text-3">
          ...
          <div className="north-guide-img-3">
            <img src={Image02} alt="" height='400px' width='500px' />
          </div>
          <div className="north-guide-img-4">
            <img src={Image01} height='400px' width='500px' alt="" />
          </div>
          <div className="north-guide-text-4">
          ...
          <div className="north-guide-img-5">
            <div className="north-mytext">
          ...
          <div className="north-guide-text">
        ...
        <div className="north-content">
          ...
          <div className="north-content-2">
            <div className="north-content2-img-1">
              <img src={Image03} alt="" height='450px' width='380px' />

            </div>
            <div className="north-content2-img-2">
              <img src={Image03} alt="" height='270px' width='380px' />

            </div>
            &nbsp;
          </div>
          <div className="north-content-3">
            <div className="north-content3-img-1">
              <img src={Image03} alt="" height='450px' width='380px' />
            </div>  &nbsp;
            <div className="north-content3-img-2">
              <img src={Image03} alt="" height='270px' width='380px' />
            </div>
          </div>
