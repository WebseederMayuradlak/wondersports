...
const WintertourGuide = () => {
  return (
    <>
      <div className="winter-tour-guide">
        <div className="winter-guide-page">
          <div className="winter-guide-text">
            <span>Winter Tour Guide - Tour Guide </span>
            <h3>
        ...
        <div className="winter-guide-1">
          <div className="winter-guide-text-1">
          ...
          <div className="winter-guide-text-3">
          ...
          <div className="winter-guide-img-3">
            <img src={Image02} alt="My Image" height="400px" width="500px" />
          </div>
          <div className="winter-guide-img-4">
            <img src={Image01} height="400px" width="500px" alt="My Image" />
          </div>
          <div className="winter-guide-text-4">
          ...
          <div className="winter-guide-img-5">
            <div className="winter-mytext">
        ...
        {/* <div className="winter-content">
          <div className="winter-content-1">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
          <div className="winter-content-2">
            <div className="winter-content2-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>
            <div className="winter-content2-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
            &nbsp;
          </div>
          <div className="winter-content-3">
            <div className="winter-content3-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>{" "}
            &nbsp;
            <div className="winter-content3-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
          </div>
          <div className="winter-content-4">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
        </div> */}
        <CollapseTour />
...
export default WintertourGuide;
