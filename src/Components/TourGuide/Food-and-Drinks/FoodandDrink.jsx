      ...
      <div className="food-and-drink">
        <div className="food-guide-page">
          <div className="food-guide-text">
            <span>food Tour Guide - Tour Guide </span>
            <h3>
        ...
        <div className="food-guide-1">
          <div className="food-guide-text-1">
          ...
          <div className="food-guide-text-3">
          ...
          <div className="food-guide-img-3">
            <img src={Image02} alt="My Image" height="400px" width="500px" />
          </div>
          <div className="food-guide-img-4">
            <img src={Image01} height="400px" width="500px" alt="My Image" />
          </div>
          <div className="food-guide-text-4">
          ...
          <div className="food-guide-img-5">
        ...
        <div className="food-content">
          <div className="food-content-1">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
          <div className="food-content-2">
            <div className="food-content2-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>
            <div className="food-content2-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
            &nbsp;
          </div>
          <div className="food-content-3">
            <div className="food-content3-img-1">
              <img src={Image03} alt="My Image" height="450px" width="380px" />
            </div>{" "}
            &nbsp;
            <div className="food-content3-img-2">
              <img src={Image03} alt="My Image" height="270px" width="380px" />
            </div>
          </div>
          <div className="food-content-4">
            <img src={Image03} alt="My Image" height="450px" width="380px" />
          </div>
        </div>
      </div>
